...
var registerDataService = function (serviceName) {
	mesh_api_describe.factory(serviceName, function (freebaseClient) {
        var _freebase = null;
    ...
    $scope.authenticate = function(){
      ...
      dataService.init($scope.dburl, $scope.dbport, $scope.dbsecret, function(e){
          if (!e){
            ...
            console.log(dataService.instance);

            dataService.instance.client.get('/mesh/description', {}, function(e, response){
