...
module.exports._initializeEndpoints = function(_this, description, freebase, config, callback) {
...
module.exports._createExchangeAPILayer = function(_this, callback) {
 _this.exchange = {};
...
module.exports._createEventAPILayer = function(_this, callback) {
    _this.exchange = {};
