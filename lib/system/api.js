...
if (typeof window === 'undefined') {
  ...
  if (!$){
    getScript('http://code.jquery.com/jquery-2.1.4.min.js', function(){
      UTILITIES.log('loaded jquery');
    });
  }
}
...
function MeshAPI(config, callback) {
  initialize(config, freebase, callback);
}

module.exports = MeshAPI;

var initialize = function(config, freebase, callback) {
