...
function ComponentInstance() {
  ...
  _this.validateInternal = function(action, data, callback){
  ...
  _this._loadModule = function(module){
    ...
    try{
      ...
      _this._operateInternal = function(action, data, callback){
        ...
        _this.validateInternal(action, data, function(e){
  ...
  _this.startInternal = function(){
    if (_this.description['start']){
        return _this.module.actions.start.call(_this.module, parameters, function(err){
